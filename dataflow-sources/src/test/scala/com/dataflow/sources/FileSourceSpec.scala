  ...
  "FileSource" when {
    ...
    "reading CSV files without header" should {
      ...
      "parse all rows as data" in {
        ...
        val firstRecord = records.head
        firstRecord.data("field0") shouldBe "100"
        firstRecord.data("field1") shouldBe "Product A"
        firstRecord.data("field2") shouldBe "50.00"
      }
    }
    ...
    "reading text files" should {
      ...
      "read line by line" in {
        ...
        firstRecord.data("line_number") shouldBe "1"
